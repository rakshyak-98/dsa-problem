...
- `bin/study_cards/` — spaced-repetition flashcards from `doc/backend/`. `go run . -- --track cards`, `... -- --track cards --due`, `... --deck=backend`. Regenerate: `python3 cards/generate_cards.py`.
