...
var reflexBySlug = map[string]string{
	...
	"sort-an-array":                         "mergeSort",
	"sort-colors":                           "dutchFlag",
	"find-greatest-common-divisor-of-array": "gcd",
	"powx-n":                                "fastPow",
	"count-primes":                          "sieve",
	"single-number":                         "singleNumber",
	"number-of-provinces":                   "dfs",
	"snakes-and-ladders":                    "bfs",
	"minimum-genetic-mutation":              "bfsShortestPath",
	"course-schedule-ii":                    "topoSort",
